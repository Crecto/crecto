module Crecto
  ...
  module Changeset(T)
    ...
    # :nodoc:
    REQUIRED_RANGE_INCLUSIONS = {} of String => Array(NamedTuple(field: Symbol, in: Range(Int32, Int32) | Range(Int64, Int64) | Range(Float64, Float64) | Range(Time, Time) | Range(Time, Time)))
    # :nodoc:
