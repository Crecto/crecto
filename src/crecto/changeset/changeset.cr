module Crecto
  module Changeset
    class Changeset
      ...
      property valid = true
      property class_key : String?
      property instance_hash : Hash(Symbol, Bool | Float64 | Int32 | Int64 | String | Nil)
      ...
      def initialize(instance)
        ...
        check_exclusions!(instance_hash)
        check_lengths!(instance_hash)
      end
      ...
      private def check_exclusions!(instance_hash)
      ...
      private def check_lengths!(instance_hash)
